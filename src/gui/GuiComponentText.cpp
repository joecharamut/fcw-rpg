...
GuiComponentText::GuiComponentText(std::string text, int width, int height, std::string fontStr, int r, int g, int b) {
    int buf_w = width;
    int buf_h = height;
    ALLEGRO_FONT *font;
    ...
    al_draw_text(font, al_map_rgb(r, g, b), 0, 0, 0, text.c_str());
}
